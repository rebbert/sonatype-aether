...
import org.sonatype.aether.SubArtifact;
    ...
    extends Task
{
        ...
        throws BuildException
    {
        ...
        List<org.sonatype.aether.RemoteRepository> repos = sys.toRepos( remoteRepositories, session );

        CollectRequest collectRequest = new CollectRequest();
        collectRequest.setRequestContext( "project" );

        for ( org.sonatype.aether.RemoteRepository repo : repos )
        {
        ...
        extends ProjectComponent
    {
        ...
        public boolean accept( org.sonatype.aether.DependencyNode node )
        {
